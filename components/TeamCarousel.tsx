      ...
      >
        {duplicatedMembers.map((member, index) => {
          ...
          return (
            <div
              key={`${member.id}-${index}`}
              className={`flex-shrink-0 w-[260px] sm:w-[300px] md:w-[350px] lg:w-[380px] bg-card border rounded-xl p-4 md:p-6 transition-all duration-300 cursor-pointer select-none ${
